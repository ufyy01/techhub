...
const RegisterPage = () => {
  ...
  return (
    <div className="bg-white w-full px-3 py-3 lg:pt-44 md:flex flex-col justify-center items-center">
      <Form {...form}>
        <form action={onSubmit} className="w-full px-2">
          <div>
